...
import com.loreJourney.battle.StatusEffect;
import com.loreJourney.entity.Player;
import com.loreJourney.event.*;
...
public class MoveUI extends BattleUI {
    ...
    public MoveUI(GameScreen gameScreen, TileMap tileMap, Player player, Battle battle,
                  com.loreJourney.ui.battleui.BattleUIHandler uiHandler, Stage stage, ResourceManager rm) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            moveButtons[i].addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    uiHandler.currentState = com.loreJourney.event.BattleState.DIALOG;
