package com.loreJourney.ui.inventory;
...
import com.loreJourney.ui.MovingImageUI;
...
public class InventoryUI extends UI {
    ...
    public InventoryUI(final LoreJourney game, Player player, final ResourceManager rm) {
