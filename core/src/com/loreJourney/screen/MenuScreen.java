...
public class MenuScreen extends MenuExtensionScreen {
    ...
    public MenuScreen(final LoreJourney game, final ResourceManager rm) {
        super(game, rm);
    ...
    public void show() {
        ...
        if (transitionIn == 0) {
            ...
            stage.addAction(Actions.sequence(Actions.moveTo(
                transitionIn == 1 ? LoreJourney.V_WIDTH : -LoreJourney.V_WIDTH, 0), Actions.moveTo(0, 0, 0.3f)));
        }
    }
    ...
    private void createCreditsScreen() {
        ...
        credits.setSize(LoreJourney.V_WIDTH, LoreJourney.V_HEIGHT);
        ...
        frame.setPosition(LoreJourney.V_WIDTH / 2 - 50, LoreJourney.V_HEIGHT / 2 - 30);
