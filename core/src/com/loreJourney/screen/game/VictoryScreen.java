...
import com.loreJourney.screen.AbstractScreen;
...
public class VictoryScreen extends AbstractScreen {
    ...
    public VictoryScreen(final LoreJourney game, final ResourceManager rm) {
        super(game, rm);

        bannerBg = new Image(rm.skin, "default-slider");
        bannerBg.setSize(120, 18);
        bannerBg.setPosition(LoreJourney.V_WIDTH / 2 - 70, 96);
        ...
        bannerText.setPosition(LoreJourney.V_WIDTH / 2 - 70, 96);
        ...
        infoBg.setPosition(LoreJourney.V_WIDTH / 2 - 70, 4);
        ...
        info.setSize(112, 50);
        info.setPosition(LoreJourney.V_WIDTH / 2 - 70 + 4, 38);
        stage.addActor(info);
